...
export default function BatchesPage() {
  ...
  return (
    <div className={staffStyles.container}>
      <Link href="/staff" className={staffStyles.backLink}>
      ...
      <div className={styles.mainContent}>
        ...
        <div className={styles.batchListPanel}>
        ...
        {/* Right Panel: Batch Details and Packages */}
                      ...
                      <div key={pkg.id} className={styles.packageCard}>
                        <div className={styles.packageHeader}>
                          <div>
                            ...
                            <span className={styles.receiverCode}>Code: {pkg.receiver_code}</span>
                          </div>
                          <div>
                            {pkg.is_collected ? (
